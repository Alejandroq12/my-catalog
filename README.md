...
- [📖 My Catalog My Catalog](#-my-catalog-my-catalog)
...
# 📖 My Catalog <a name="about-project">My Catalog</a>
...
- **Keep record of books, movies, and games that I own.**
...
```sh
  cd my-folder
  git clone https://github.com/Alejandroq12/my-catalog.git
```
